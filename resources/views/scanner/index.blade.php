            ...
            <div class="flex flex-wrap items-center justify-between gap-4">
                <div>
                    ...
                    @if($brand->website_url)
                        <p class="text-sm text-gray-500 mt-1">Tracking: <span
                                class="font-medium">{{ $brand->website_url }}</span></p>
                    @endif
                </div>
                <div class="flex flex-wrap gap-2">
                    <form action="{{ route('scanner.scan-all') }}" method="POST" id="scanAllForm">
                        ...
                        <button type="submit" id="scanAllBtn"
                                ...
                                @foreach($snapshots as $snapshot)
                                    <tr>
                                        ...
                                        <td class="py-2 text-sm text-gray-700 text-right">
                                            {{ number_format($snapshot->word_count ?? 0) }}</td>
                                        <td class="py-2 text-sm text-gray-700 text-right">
                                            @php
                                        ...
                                        <td class="py-2 text-sm text-gray-700 text-right">
                                            <a href="{{ route('scanner.show', $snapshot->id) }}"
